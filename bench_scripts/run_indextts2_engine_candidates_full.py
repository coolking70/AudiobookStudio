...
VARIANTS = [
    {"engine": "IndexTTS2-full-greedy", "infer": {**BASE}},
    {"engine": "IndexTTS2-full-greedy-diff16", "infer": {**BASE, "diffusion_steps": 16}},
    {"engine": "IndexTTS2-full-greedy-diff16-cfg03", "infer": {**BASE, "diffusion_steps": 16, "inference_cfg_rate": 0.3}},
]
...
def main() -> int:
    ...
    refs = prepare_ascii_refs(OUTPUT_ROOT / "_indextts2_engine_candidates_refs")
    ...
    warmup_path = OUTPUT_ROOT / "_indextts2_engine_candidates_warmup.wav"
    print("IndexTTS2 engine candidates warmup start", flush=True)
    model.infer(
    ...
    print("IndexTTS2 engine candidates warmup done", flush=True)
