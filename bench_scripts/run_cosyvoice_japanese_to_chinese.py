...
from common_japanese_to_chinese import OUTPUT_ROOT, TARGET_TEXTS, ResultRow, prepare_ascii_refs, timed_generate, write_manifest
...
def main() -> int:
    ...
    rows: list[ResultRow] = []
    for ref in refs:
        for phrase_id, text in TARGET_TEXTS:
