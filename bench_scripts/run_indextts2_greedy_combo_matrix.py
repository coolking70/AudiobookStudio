...
VARIANTS = [
    {"engine": "IndexTTS2-greedycombo-greedy", "infer": {**BASE}},
    {"engine": "IndexTTS2-greedycombo-diff20", "infer": {**BASE, "diffusion_steps": 20}},
    {"engine": "IndexTTS2-greedycombo-diff16", "infer": {**BASE, "diffusion_steps": 16}},
    {"engine": "IndexTTS2-greedycombo-cfg03", "infer": {**BASE, "inference_cfg_rate": 0.3}},
    {"engine": "IndexTTS2-greedycombo-diff16-cfg03", "infer": {**BASE, "diffusion_steps": 16, "inference_cfg_rate": 0.3}},
]
...
def main() -> int:
    ...
    refs = prepare_ascii_refs(OUTPUT_ROOT / "_indextts2_greedy_combo_refs")[:2]
    ...
    warmup_path = OUTPUT_ROOT / "_indextts2_greedy_combo_warmup.wav"
    print("IndexTTS2 greedy combo matrix warmup start", flush=True)
    model.infer(
    ...
    print("IndexTTS2 greedy combo matrix warmup done", flush=True)
